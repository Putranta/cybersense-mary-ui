...
<div class="min-h-[100vh] overflow-hidden pb-40 pt-10 px-4 lg:px-8">
    <h1 class="font-title text-center text-[clamp(2rem,8vw,3rem)] font-black leading-none xl:text-center">
        ...
        <br>
        <span class="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500">CyberSense
            UMKM</span>
    </h1>
    ...
    <ul class="timeline timeline-vertical pt-10 lg:px-20 pb-10 hidden lg:block">
        ...
        <li>
            ...
            <div class="timeline-start text-right timeline-box">
                <span
                    class="text-[clamp(1.3rem,8vw,1rem)] bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500">
                    3. Mengisi Penilaian Cek Risiko
                </span> <br>
                Mengisi semua data yang diperlukan, buka halaman Cek Risiko.
                Anda akan melihat Form pengisian tentang risiko keamanan siber di bisnis Anda, beserta skor dan
        ...
        <li>
            ...
            <div class="timeline-end text-right timeline-box">
                <span
                    class="text-[clamp(1.3rem,8vw,1rem)] bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500">
                    4. Lihat Hasil Penilaian Risiko
                </span> <br>
        ...
        <li>
            ...
            <div class="timeline-start timeline-box">
                <span
                    class="text-[clamp(1.3rem,8vw,1rem)] bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500">
                    5. Terapkan Rekomendasi Keamanan Siber
                </span> <br>
        ...
        <li>
            ...
            <div class="timeline-end text-right timeline-box">
                <span
                    class="text-[clamp(1.3rem,8vw,1rem)] bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500">
                    6. Pantau dan Perbarui Profil Secara Berkala
                </span> <br>
    ...
    <div class="timeline-start text-center timeline-box border border-warning">
        <span
            class="text-[clamp(1.5rem,8vw,1rem)] bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500">Tips
            Penting</span> <br>
        <ul>
            <li>
                <strong>Berikan Data yang Akurat</strong> <br>Data yang akurat akan menghasilkan penilaian risiko yang
                tepat, sehingga saran yang diberikan akan relevan dengan kebutuhan Anda.
            </li>
            <li>
                <strong>Lakukan Penilaian Rutin</strong> <br>Keamanan siber selalu berkembang, jadi disarankan untuk
                melakukan penilaian setiap 3–6 bulan.
            </li>
            <li>
                <strong>Libatkan Karyawan</strong> <br> Bagikan hasil dan rekomendasi kepada tim Anda untuk meningkatkan
                kesadaran dan tanggung jawab terhadap keamanan siber.
            </li>
        </ul>
    </div>
</div>
